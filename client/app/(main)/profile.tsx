    ...
    <View style={[styles.container, { backgroundColor: currentColors.background }]}>
      ...
      <ScrollView contentContainerStyle={[styles.scrollContent, { paddingBottom: bottomPadding }]}>
        ...
        <View style={[styles.menuContainer, { backgroundColor: currentColors.card, borderColor: currentColors.border }]}>
          {['Edytuj profil', 'Moje statystyki', 'Osiągnięcia', 'Zaproś znajomych', 'Wyloguj się'].map((item, index) => (
            <TouchableOpacity key={item} style={[styles.menuItem, index !== 4 && { borderBottomWidth: 1, borderBottomColor: currentColors.border }]}>
